...
<body>
  <?php
   ...
   if (isset($_POST['review_id']) && isset($_POST['user_id']) && is_numeric($_POST['review_id']) && is_numeric($_POST['user_id'])){
    echo '<form action="createdReviews.php" method="post" id="createdReview">
     ...
     $createdReviewURL = '/php/createdReviews.php';
      echo '<script language="javascript">';
      echo 'alert("Review has been deleted");';
      echo 'document.getElementById("createdReview").submit();';
      echo '</script>';
